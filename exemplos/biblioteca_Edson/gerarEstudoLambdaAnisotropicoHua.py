...
def rodar_simulacao(lambda_val, html_name="resultado"):
    ...
    invProblem_2D.solve(V_measured_phaton, initialEstimate=start,alpha =0.075,  Lambda = lambda_val, max_iter= 50,Tol=1.0e-9, html_name = htmlName)
